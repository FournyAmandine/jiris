...
<head>
    ...
    <title>{!! __('page-title.list_contacts') !!} - Jiri</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="w-2/5 m-auto">
<header class="flex items-center justify-center mb-10 mt-10">
    <svg width="100px" height="100px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
<style type="text/css">
    ...
    @foreach($contacts as $contact)
        <div class="relative shadow-2xl rounded-2xl mb-8 flex hover:scale-105 p-5">
            <a class="absolute top-0 left-0 right-0 bottom-0 w-1/1 inline-block hover:text-blue-800 text-lg"
               href="{{route('contacts.show', $contact->id)}}"></a>
